...
export class Sheet {
    ...
    createContextMenu() {
        ...
        // deleteOption.onclick = deleteRow; // Bind the delete function
        ul.appendChild(deleteOption);

        const insertBeforeOption = document.createElement('li');
        insertBeforeOption.textContent = 'Insert a Row Before';

        const insertAfterOption = document.createElement('li');
        insertAfterOption.textContent = 'Insert a Row After';
        // addOption.onclick = addRow; // Bind the add function
        ul.appendChild(insertBeforeOption);
        ul.appendChild(insertAfterOption);
