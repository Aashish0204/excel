    ...
    handleKeyEventsOnSheet() {
        window.addEventListener('keydown', (e) => {
            ...
            if (((e.ctrlKey && e.key === 'c' && this.isDragging == false) || (e.ctrlKey && e.key === 'x' && this.isDragging == false))) {
                ...
                this.sheet.handleApis.insertRows(this.selectRowStart,1);
                console.log("calling function insert for index as ",this.selectRowStart)
                this.sheet.ll.insertRows(this.selectRowStart,1);
                this.sheet.renderer.renderCanvas();
            }
        })
    }
